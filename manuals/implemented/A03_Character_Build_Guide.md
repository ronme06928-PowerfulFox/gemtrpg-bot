<!-- 旧: 04_Character_Build_Guide.md を A 系列へ移管 (2026-05-09) -->
# キャラクタービルドガイド
...
<td>3</td>
<td><strong>【キーカード】</strong> 出血5と「出血遷延」を付与。出血ダメージ処理時の減衰を回数制で阻止できる強力なデバフ。</td>
</tr>
<tr>
...
2. **戦闘スキル追加: `Ms-04 手足とお別れ` (Cost 2)**
    * 出血が溜まった後半戦で「出血氾濫」を狙います（即時で出血ダメージ処理が走るため、決定打になりやすい）。
3. **戦闘スキル追加: `Ms-10 一心不乱` (Cost 2)**
