...
**作成日**: 2026-07-07（最終更新: 2026-07-12 — 計画36を実装完了扱いでクローズ・削除。正本はF01 Part9/E02 Part6/A01・A02追補）
...
3. **戦闘メモリ設計が要る**: 12（逆襲）
4. 28・31・32・33・34・36は実装完了/クローズ。残る計画書は04・12・13・16・24・30・35の7本。
5. **本命**: 35（ホロウ）のPhase 0から着手可能。前提の36（キャラ管理）は実装完了済みなので、味方キャラの持ち込み（持ちキャラ投入）はそのまま使える。35の残論点は準備作業・技術検証3件のみ。
