...
- 仕様書 `manuals/implemented/09_SelectResolve_Spec.md` には「同速グループだけ追加ロールで順序確定」と記載があります。
...
- UI特化の一時計画書の内容は、本追補および恒常仕様書へ統合した。
- 恒常仕様として残す内容は `manuals/implemented/09_SelectResolve_Spec.md` と `manuals/implemented/06_Visual_Battle_Architecture.md` に反映する。
